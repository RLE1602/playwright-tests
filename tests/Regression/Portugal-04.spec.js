...
test('Portugal-04 Existing customer with public promotion and regular payment method-credit card (Visa).spec.js', async ({ page }) => {
  ...
  await page.locator('//p[normalize-space()="I have a promo code"]').nth(0).click();
  await page.locator('//input[@class="rounded-md form-input"]').nth(0).fill('PBLC0226');
  await page.locator('//button[normalize-space()="Apply"]').click();
  /*await page.getByText('I have a promo code').scrollIntoViewIfNeeded();
  await page.locator('//p[normalize-space()="I have a promo code"]').nth(1).click();
  await page.locator('//input[@class="rounded-md form-input"]').nth(1).fill('SHIP0226');
  await page.locator('//button[normalize-space()="Apply"]').click();*/
  ...
  await page.locator('//p[normalize-space()="I have a promo code"]').nth(0).click();
  await page.locator('//input[@class="rounded-md form-input"]').nth(0).fill('SHIP0226');
  await page.locator('//button[normalize-space()="Apply"]').nth(0).click();

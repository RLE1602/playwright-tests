...
test('Portugal-16 Multiple Address Selection Validation (Complete the checkout flow until the Address page, select multiple saved addresses, return to the Cart to update items, verify address changes))', async ({ page }) => {
  //Login

...
test('Portugal-11 Complete the checkout flow until the Shipping Method page, return to the Cart to update items and addresses, verify all changes, and then place the order', async ({ page }) => {
  //Login

...
test('Portugal-10 Complete the checkout flow until the Address page, return to the Cart to update items, verify all changes, and then place the order', async ({ page }) => {
  //Login

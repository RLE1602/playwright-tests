...
test('Portugal-12 Complete the checkout flow until the Payment page, return to the Cart to update items, addresses, and shipping/payment methods, verify all changes, and then place the order', async ({ page }) => {
  //Login

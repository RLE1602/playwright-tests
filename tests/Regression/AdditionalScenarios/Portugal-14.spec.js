...
test('Portugal-14 Shipping Method Change Validation (Complete the checkout flow until the Shipping Method page, return to the Cart to update items, verify the updated shipping cost, and then place the order)', async ({ page }) => {
  //Login

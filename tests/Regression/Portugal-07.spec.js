...
test('Portugal-07 Existing customer should be able to place order and ship to another country Spain', async ({ page }) => {
  ...
  await page.getByRole('textbox', { name: 'Email Address' }).fill('portugal_user3@yopmail.com');
